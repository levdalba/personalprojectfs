        ...
        @foreach ($projects as $project)
            <div class="bg-white shadow-lg rounded-lg overflow-hidden my-6">
                ...
                <div class="p-4">
                    ...
                    <a href="{{ $project->Github_link }}" class="inline-block bg-blue-500 text-white rounded-full px-3 py-1 text-sm font-semibold hover:bg-blue-700 transition-colors">View on GitHub</a>
                </div>
            </div>
        @endforeach
    </div>
